...
import TeamImage01 from '@/public/images/Danny.jpg'
import TeamImage02 from '@/public/images/ValleyTrash.jpg'
import TeamImage03 from '@/public/images/OpenJob.png'
        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="sm:flex sm:flex-wrap sm:justify-center -my-4 sm:-my-8 sm:-mx-3" data-aos-id-team>
            ...
            <div className="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]">
              ...
              <Image className="rounded-full mb-4" src={TeamImage01} width={120} height={120} alt="Danny" />
            ...
            <div className="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-team]">
              <div className="flex flex-col items-center">
              <Image className="rounded-full mb-4" src={TeamImage02} width={120} height={120} alt="Valley Trash (Alaskan joke)" />
            ...
            <div className="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]">
              ...
              <Image className="rounded-full mb-4" src={TeamImage03} width={120} height={120} alt="Team member 03" />                <div className="text-xl font-medium mb-1">Open Position/💰 $100k</div>
            ...
            <div className="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up" data-aos-anchor="[data-aos-id-team]">
              <div className="flex flex-col items-center text-center">
              <Image className="rounded-full mb-4" src={TeamImage03} width={120} height={120} alt="Team member 03" />                <div className="text-xl font-medium mb-1">Join the Network/💰💰💰</div>
            ...
            <div className="sm:w-1/2 md:w-1/3 lg:w-1/4 py-4 sm:py-8 sm:px-3" data-aos="fade-up" data-aos-delay="50" data-aos-anchor="[data-aos-id-team]">
              <div className="flex flex-col items-center text-center">
              <Image className="rounded-full mb-4" src={TeamImage03} width={120} height={120} alt="Team member 03" />                <div className="text-xl font-medium mb-1">Innovators/💰💰💰</div>
