            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up" data-aos-anchor="[data-aos-id-features-home]">
                <div className="relative">
                     <Image className="md:max-w-none" src={FeatIllustration} width={540} height={520} alt="Features illustration" />                  <svg className="absolute inset-0 max-w-full mx-auto md:max-w-none h-auto" width="540" height="520" viewBox="0 0 540 520" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Seamless Data Synergy</h3>
                  <p className="text-xl text-gray-400 mb-4">Welcome to Minion Protocol – where your data initiates a cascade of trust through 'Babble about Babble,' our distributedm, intelligent, layered chainmail network. Experience lightning-fast workflows and revolutionary rewards with each contribution, all under the vigilant guard of zero-proof trust. Innovate, share, thrive.</p>
                  <ul className="flex flex-wrap text-lg text-gray-400 -mx-2 -my-1">
                    ...
                    <li className="flex items-center mx-2 my-1">
                      ...
                      <span>Endless Billables</span>
                    </li>
                  </ul>
                  <div className="flex items-start mt-8">
                      <Image className="rounded-full shrink-0 mr-4" src={FeatAvatar} width={40} height={40} alt="Features avatar" />                    <div>
                      <blockquote className="text-gray-400 italic mb-3">"Because, I mean... fuck, someone had to do it ".</blockquote>
                      <div className="text-gray-700 font-medium">
                        <cite className="text-gray-200 not-italic">— @YoMomma</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Lore Keeper</a>
                      </div>
                    </div>
                  </div>
                </div>
