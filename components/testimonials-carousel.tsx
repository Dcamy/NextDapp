...
export default function TestimonialsCarousel() {
  ...
  const items: Item[] = [
    {
      img: UserImage06,
      alt: 'Innovator Testimonial',
      quote: `“Plunging into the depths of iChain, I've shattered conventional boundaries and propelled my capabilities to new heights. iChain isn't just a tool; it's a beacon, guiding us towards uncharted territories of innovation and collaboration. Join us on this journey and transform your potential into impact!”`,
      name: 'Skye Innovato',
      role: 'Tech Futurist'
    },
    {
      img: UserImage04,
      alt: 'Futurist Insight',
      quote: `“Riding the wave of iChain innovation, I’ve hacked the status quo, blending bytes and beliefs. In this realm, we’re not just builders; we’re dreamers scaling the edge of tomorrow. Here's your invite—let's co-create reality!”`,
      name: 'Neo Cortex',
      role: 'Blockchain Visionary'
    },
    {
      img: UserImage05,
      alt: 'Pioneer Perspective',
      quote: `“iChain is not just a platform; it's a revolution. Stepping into this arena, I’ve found my tribe—coders, creators, changemakers. Every line of code we commit weaves into the digital tapestry of the future. Ready to leave your mark?”`,
      name: 'Alex Pioneero',
