...
import TeamMosaic01 from '@/public/images/team-mosaic-01.webp'
import TeamMosaic02 from '@/public/images/team-mosaic-02.png'
import TeamMosaic03 from '@/public/images/team-mosaic-03.png'
import TeamMosaic04 from '@/public/images/team-mosaic-04.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="relative w-full h-0 pb-3/4">
            ...
            <figure className="relative mx-auto h-auto" style={{ width: '78.13%', maxWidth: '350px' }} data-aos="fade-down" data-aos-delay="100">
